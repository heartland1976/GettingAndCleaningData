...
The data containing activities looks as follows:  
    5
    5
    4
    4

This is not very descriptive. A file named activity_labels.txt contains the mapping of each of the identifiers to a textual, thus more readable description. The above list is therefore changed like such:
    STANDING
    STANDING
    SITTING
    SITTING
...
After transformation and means calculation a row will look like this:
